<!-- Mobile Header -->
<header class="sticky top-0 z-[9999] flex h-[100px] bg-black/80 backdrop-blur-xl md:hidden">
...
<div id="mobile-menu" class="fixed inset-0 z-[99999] -translate-y-full bg-black/95 backdrop-blur-xl transition-transform duration-300 ease-in-out md:hidden">
