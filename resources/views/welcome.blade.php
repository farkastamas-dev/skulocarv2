...
<body class="bg-dark-bg text-dark-text">
    ...
    <header class="bg-dark-bg border-dark-border fixed left-0 right-0 top-0 z-40 border-b">
        <div class="container mx-auto flex h-24 items-center justify-between px-4">
            ...
            <nav class="desktop-menu hidden md:flex md:items-center md:space-x-3">
                ...
                <!-- Kapcsolat -->
                <a href="#contact" class="rtext-dark-text px-3 py-2 transition-all duration-300 hover:text-yellow-400">
                    Kapcsolat
                </a>
            </nav>
    ...
    <main class="pt-24">
        ...
        <div class="hero-slider-container relative">
            <!-- Slider 1 - Main Hero -->
            <section class="hero-slider slider-1 flex items-center" id="slider-1" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.8) 100%), url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
                    ...
                    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        ...
                        <div class="hero-content hero-text">
                            <h1 class="mb-6 text-4xl font-bold text-white md:text-6xl">
                                SkuloCar
                                <span class="text-yellow-400">Autószerviz</span>
                            </h1>
                            <div class="hidden md:block">
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row">
                                    <a href="#contact" class="ripple rounded-lg bg-yellow-500 px-8 py-4 text-lg font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-yellow-400">
                                        <i class="fa-solid fa-phone mr-2"></i>Kapcsolat
                                    </a>
                                    <a href="/services" class="ripple rounded-lg border-2 border-yellow-500 px-8 py-4 text-lg font-semibold text-yellow-500 transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            ...
            <!-- Slider 2 - Services -->
            <section class="hero-slider slider-2 flex hidden items-center" id="slider-2" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.8) 100%), url('https://images.unsplash.com/photo-1580273916550-e323be2ae537?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        <div class="hero-content hero-text">
                            <h1 class="mb-6 text-4xl font-bold text-white md:text-6xl">
                                Professzionális
                                <span class="text-yellow-400">Szerviz</span>
                            </h1>
                            <div class="hidden md:block">
                                <p class="mb-8 text-xl leading-relaxed text-gray-300">
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row">
                                    <a href="/services" class="ripple rounded-lg bg-yellow-500 px-8 py-4 text-lg font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-yellow-400">
                                        <i class="fa-solid fa-tools mr-2"></i>Szolgáltatások
                                    </a>
                                    <a href="#contact" class="ripple rounded-lg border-2 border-yellow-500 px-8 py-4 text-lg font-semibold text-yellow-500 transition-all duration-300 hover:bg-yellow-500 hover:text-black">
            ...
            <!-- Slider 3 - Parts -->
            <section class="hero-slider slider-3 flex hidden items-center" id="slider-3" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.8) 100%), url('https://images.unsplash.com/photo-1503376780353-7e6692767b70?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        <div class="hero-content hero-text">
                            <h1 class="mb-6 text-4xl font-bold text-white md:text-6xl">
                                Autóalkatrészek
                                <span class="text-yellow-400">Katalógus</span>
                            </h1>
                            <div class="hidden md:block">
                                <p class="mb-8 text-xl leading-relaxed text-gray-300">
                                ...
                                <div class="flex flex-col gap-4 sm:flex-row">
                                    <a href="#" class="ripple rounded-lg bg-yellow-500 px-8 py-4 text-lg font-semibold text-black transition-all duration-300 hover:scale-105 hover:bg-yellow-400">
            ...
            <!-- Slider 4 - Cars -->
            <section class="hero-slider slider-4 flex hidden items-center" id="slider-4" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.8) 100%), url('https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        <div class="hero-content hero-text">
                            <h1 class="mb-6 text-4xl font-bold text-white md:text-6xl">
                                Autókereskedés
                                <span class="text-yellow-400">SkuloCar</span>
                            </h1>
                            <div class="hidden md:block">
                                <p class="mb-8 text-xl leading-relaxed text-gray-300">
            ...
            <!-- Slider 5 - Contact -->
            <section class="hero-slider slider-5 flex hidden items-center" id="slider-5" style="background: linear-gradient(135deg, rgba(0, 0, 0, 0.8) 0%, rgba(26, 26, 26, 0.8) 50%, rgba(10, 10, 10, 0.8) 100%), url('https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80');">
                <div class="container mx-auto px-4">
                    <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                        <div class="hero-content hero-text">
                            <h1 class="mb-6 text-4xl font-bold text-white md:text-6xl">
            ...
            <!-- Slider Navigation -->
            <div class="absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 space-x-4">
                <button class="slider-nav-btn h-3 w-3 rounded-full bg-white/50 transition-all duration-300 hover:bg-white" data-slider="1"></button>
                <button class="slider-nav-btn h-3 w-3 rounded-full bg-white/30 transition-all duration-300 hover:bg-white" data-slider="2"></button>
                <button class="slider-nav-btn h-3 w-3 rounded-full bg-white/30 transition-all duration-300 hover:bg-white" data-slider="3"></button>
                <button class="slider-nav-btn h-3 w-3 rounded-full bg-white/30 transition-all duration-300 hover:bg-white" data-slider="4"></button>
                <button class="slider-nav-btn h-3 w-3 rounded-full bg-white/30 transition-all duration-300 hover:bg-white" data-slider="5"></button>
            </div>
                ...
                <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
                    ...
                    <div class="space-y-6">
                        <h2 class="text-3xl font-bold text-white md:text-4xl">
                            Üdvözöli Önt a <span class="text-yellow-400">SkuloCar Kft.</span>!
                        </h2>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
                    <div class="bg-dark-card group relative overflow-hidden rounded-lg p-6 transition-all duration-300 hover:scale-105">
                        <div class="mb-4 flex h-16 w-16 items-center justify-center rounded-lg bg-yellow-500 transition-all duration-300 group-hover:bg-yellow-400">
                        ...
                        <a href="#" class="inline-flex items-center text-yellow-400 transition-all duration-300 hover:translate-x-1 hover:text-yellow-300">
        ...
        <section id="contact" class="bg-dark-bg py-16">
            <div class="container mx-auto px-4">
                <h2 class="mb-12 text-center text-3xl font-bold">Kapcsolat</h2>
                <div class="mx-auto max-w-2xl">
                    <form class="space-y-6">
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <input type="text" placeholder="Név" class="bg-dark-card w-full rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 focus:outline-none">
                            <input type="tel" placeholder="Telefon" class="bg-dark-card w-full rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 focus:outline-none">
                        </div>
                        <input type="email" placeholder="Email" class="bg-dark-card w-full rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 focus:outline-none">
                        <textarea rows="5" placeholder="Üzenet" class="bg-dark-card w-full rounded-lg border border-gray-600 px-4 py-3 focus:border-yellow-500 focus:outline-none"></textarea>
